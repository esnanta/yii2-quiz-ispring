...
namespace common\modules\quizresult\classes\question\multiple_choice;

use quizresult\classes\question\Text;
...
class MultipleChoiceSurveyAnswer extends Text
{
    ...
    {
        return parent::getValue() . ' MultipleChoiceSurveyAnswer.class.php' . $this->customAnswer;
    }
