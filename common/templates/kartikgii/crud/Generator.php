    ...
    public function generateActiveField($attribute)
    {
        ...
        if ($tableSchema === false || !isset($tableSchema->columns[$attribute])) {
            if (preg_match('/^(password|pass|passwd|passcode)$/i', $attribute)) {
                return "'$attribute' => ['type' => TabularForm::INPUT_PASSWORD,'options' => ['placeholder' => 'Enter ".(isset($attributeLabels[$attribute]) ? $attributeLabels[$attribute] : $attribute)."...']],";
                //return "\$form->field(\$model, '$attribute')->passwordInput()";
            } else {
                return "'$attribute' => ['type' => TabularForm::INPUT_TEXT, 'options' => ['placeholder' => 'Enter ".(isset($attributeLabels[$attribute]) ? $attributeLabels[$attribute] : $attribute)."...']],";
        ...
        if ($column->phpType === 'boolean') {
            ...
            return "'$attribute' => ['type' => Form::INPUT_CHECKBOX, 'options' => ['placeholder' => 'Enter ".(isset($attributeLabels[$attribute]) ? $attributeLabels[$attribute] : $attribute)."...']],";
        } elseif ($column->type === 'text') {
            //return "\$form->field(\$model, '$attribute')->textarea(['rows' => 6])";
            return "'$attribute' => ['type' => Form::INPUT_TEXTAREA, 'options' => ['placeholder' => 'Enter ".(isset($attributeLabels[$attribute]) ? $attributeLabels[$attribute] : $attribute)."...','rows' => 6]],";
            ...
            if ($column->phpType !== 'string' || $column->size === null) {
                ...
                return "'$attribute' => ['type' => Form::".$input.", 'options' => ['placeholder' => 'Enter ".(isset($attributeLabels[$attribute]) ? $attributeLabels[$attribute] : $attribute)."...']],";
            } else {
                //return "\$form->field(\$model, '$attribute')->$input(['maxlength' => $column->size])";
                return "'$attribute' => ['type' => Form::".$input.", 'options' => ['placeholder' => 'Enter ".(isset($attributeLabels[$attribute]) ? $attributeLabels[$attribute] : $attribute)."...', 'maxlength' => ".$column->size."]],";
            }
        }
    }
