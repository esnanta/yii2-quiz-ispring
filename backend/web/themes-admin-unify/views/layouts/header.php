...
<header id="js-header" class="u-header u-header--sticky-top">
    <div class="u-header__section u-header__section--admin-dark g-min-height-65">
            ...
            <div class="col-auto d-flex g-py-12 g-pl-40--lg ml-auto">
                ...
                <?= 
                    ($flushMenuEnabled==true) ? 
                        Html::a(
                                    '<i class="fa fa-recycle g-absolute-centered"></i>',
                                    ['/site/flush'],
                                    ['data-method' => 'post', 
                ...
                <?= 
                    (!Yii::$app->user->isGuest) ? 
                        $this->render('header_notification.php',['model'=>$staff])
                        :'';  
                ?>
                ...
                <!-- Top User -->
                    <?= 
                        (!Yii::$app->user->isGuest) ? 
                            $this->render('header_top_user.php',['model'=>$staff])
                            :'';  
                    ?>
                <!-- End Top User -->
            </div>
        ...
        <!-- Top Activity Panel -->
            <?= 
                ($activityMenuEnabled==true) ? 
                    $this->render('header_activity.php',['officeId'=>$officeId])
                    :'';  
            ?>
